...
BUCLE
	LDR r5,[r1],#4	; pos n de vector ORIGEN en r5
	LDR r6,[r2],#4	; pos n+1 de vector ORIGEN en r6
	ADD r6,r6,r6	; (n+1)*2 en r6
	LDR r7,[r3],#4	; pos n+2 de vector ORIGEN en r7

	ADD r8,r5,r7	; r8= n + (n+2)
	SUB r9,r6,r8	; r9 = 2*(n+1) - (n + (n+2))

	STR r9,[r4],#4	; almacenamos r9 en pos n de vector DESTINO
